...
class ResumeApp:
    ...
    def apply_global_styles(self):
        st.markdown("""
        <style>
        /* ── BLACK + ORANGE MONOCHROMATIC INLINE OVERRIDES ── */
        ...
        .template-card::before { display: none; }
        ...
        @media (max-width: 768px) {
            .template-container { grid-template-columns: 1fr; }
            .main-header h1 { font-size: 1.8rem; }
            .template-card { padding: 1.25rem; }
            .action-button { padding: 0.7rem 1.2rem; }
        }
        </style>
        """, unsafe_allow_html=True)
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center; font-size: 13px; color: #FF6B00;'>
                Made with ❤️
            </p>
            """, unsafe_allow_html=True)
    ...
    st.session_state.form_data['skills_categories']['tools']),
        ...
        if st.button("Generate Resume 📄", type="primary"):
            ...
            email_val = st.session_state.get('email_input', '')
            print(f"Email input value: {email_val}")
